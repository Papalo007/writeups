---
title: 🔒 Fries (Active)
description: Full HackTheBox Fries machine walkthrough and exploitation steps.
keywords: [HTB, writeup, fries, walkthrough]
sidebar_position: 3
...
Difficulty: Hard, OS: Windows, Creators: [ruycr4ft](https://app.hackthebox.com/users/1253217) & [kavigihan](https://app.hackthebox.com/users/389926)
